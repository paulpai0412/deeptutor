...
const MODEL_CHILDREN: SettingsLeaf[] = [
  ...
  },
  {
    ...
    label: { zh: '嵌入模型', zhTW: '嵌入模型', en: 'Embedding' },
    blurb: {
      zh: '向量模型供应商与维度。',
      zhTW: '向量模型供應商與維度。',
  ...
  },
  {
    ...
    label: { zh: '搜索', zhTW: '搜尋', en: 'Search' },
    blurb: { zh: '联网搜索供应商。', zhTW: '聯網搜尋供應商。', en: 'Web search providers.' },
    icon: Search,
  ...
  },
  {
    key: 'tts',
    href: '/settings/tts',
    label: { zh: '语音合成', zhTW: '語音合成', en: 'Text-to-Speech' },
    blurb: {
      zh: '朗读助手回复的 TTS 供应商。',
      zhTW: '朗讀助手回覆的 TTS 供應商。',
  ...
  },
  {
    key: 'stt',
    href: '/settings/stt',
    label: { zh: '语音识别', zhTW: '語音識別', en: 'Speech-to-Text' },
    blurb: {
      zh: '转写麦克风录音的 STT 供应商。',
      zhTW: '轉寫麥克風錄音的 STT 供應商。',
  ...
  },
  {
    ...
    label: { zh: '即时语音', zhTW: '即時語音', en: 'Realtime Voice' },
    blurb: {
      zh: 'GPT-Live 模型授权、音色与连接测试。',
      zhTW: 'GPT-Live 模型授權、音色與連線測試。',
  ...
  },
  {
    key: 'imagegen',
    href: '/settings/image',
    label: { zh: '文生图', zhTW: '文生圖', en: 'Image Generation' },
    blurb: {
      zh: 'chat imagegen 工具使用的文生图模型。',
      zhTW: 'chat imagegen 工具使用的文生圖模型。',
  ...
  },
  {
    key: 'videogen',
    href: '/settings/video',
    label: { zh: '文生视频', zhTW: '文生影片', en: 'Video Generation' },
    blurb: {
      zh: 'chat videogen 工具使用的文生视频模型。',
      zhTW: 'chat videogen 工具使用的文生影片模型。',
...
const CHAT_CHILDREN: SettingsLeaf[] = [
  ...
  },
  {
    key: 'mcp',
    href: '/settings/mcp',
    label: { zh: 'MCP 服务器', zhTW: 'MCP 伺服器', en: 'MCP servers' },
    blurb: {
      zh: '部署共享的外部 MCP 服务器。',
      zhTW: '部署共享的外部 MCP 伺服器。',
  ...
  },
  {
    ...
    label: { zh: '能力', zhTW: '能力', en: 'Capabilities' },
    blurb: {
      zh: '各能力的 LLM 参数与运行时旋钮。',
      zhTW: '各能力的 LLM 參數與執行時旋鈕。',
  ...
  },
  {
    ...
    label: { zh: '附件', zhTW: '附件', en: 'Attachments' },
    blurb: {
      zh: '聊天附件的大小上限与文本提取预算。',
      zhTW: '聊天附件的大小上限與文字提取預算。',
...
const AGENT_CHILDREN: SettingsLeaf[] = [
  {
    ...
    label: { zh: 'Claude Code', zhTW: 'Claude Code', en: 'Claude Code' },
    blurb: {
      zh: 'DeepTutor 调用本机 Claude Code 时的模型、推理强度与运行参数。',
      zhTW: 'DeepTutor 呼叫本機 Claude Code 時的模型、推理強度與執行參數。',
  ...
  },
  {
    ...
    label: { zh: 'Codex', zhTW: 'Codex', en: 'Codex' },
    blurb: {
      zh: 'DeepTutor 调用本机 Codex 时的模型、推理强度与运行参数。',
      zhTW: 'DeepTutor 呼叫本機 Codex 時的模型、推理強度與執行參數。',
  ...
  },
  {
    ...
    label: { zh: 'Gemini CLI', zhTW: 'Gemini CLI', en: 'Gemini CLI' },
    blurb: {
      zh: 'DeepTutor 调用本机 Gemini CLI 时的模型与运行参数。',
      zhTW: 'DeepTutor 呼叫本機 Gemini CLI 時的模型與執行參數。',
  ...
  },
  {
    ...
    label: { zh: 'Kimi CLI', zhTW: 'Kimi CLI', en: 'Kimi CLI' },
    blurb: {
      zh: 'DeepTutor 调用本机 Kimi CLI 时的模型与运行参数。',
      zhTW: 'DeepTutor 呼叫本機 Kimi CLI 時的模型與執行參數。',
  ...
  },
  {
    ...
    label: { zh: 'opencode', zhTW: 'opencode', en: 'opencode' },
    blurb: {
      zh: 'DeepTutor 调用本机 opencode 时的模型、推理强度与运行参数。',
      zhTW: 'DeepTutor 呼叫本機 opencode 時的模型、推理強度與執行參數。',
  ...
  },
  {
    ...
    label: { zh: 'MiMo Code', zhTW: 'MiMo Code', en: 'MiMo Code' },
    blurb: {
      zh: 'DeepTutor 调用本机 MiMo Code 时的模型、推理强度与运行参数。',
      zhTW: 'DeepTutor 呼叫本機 MiMo Code 時的模型、推理強度與執行參數。',
...
export const SETTINGS_CATEGORIES: SettingsCategory[] = [
  {
    key: 'appearance',
    label: { zh: '外观', zhTW: '外觀', en: 'Appearance' },
    blurb: {
      zh: '视觉主题与界面语言',
      zhTW: '視覺主題與介面語言',
  ...
  {
    key: 'network',
    label: { zh: '网络', zhTW: '網路', en: 'Network' },
    blurb: {
      zh: '端口、浏览器 API 地址与 CORS',
      zhTW: '埠、瀏覽器 API 地址與 CORS',
  ...
  {
    key: 'models',
    label: { zh: '模型', zhTW: '模型', en: 'Models' },
    blurb: {
      zh: '语言、向量、搜索、语音与生成模型',
      zhTW: '語言、向量、搜尋、語音與生成模型',
  ...
  {
    key: 'knowledge',
    label: { zh: '知识库', zhTW: '知識庫', en: 'Knowledge Base' },
    blurb: { zh: '文档解析引擎', zhTW: '文件解析引擎', en: 'Document parsing engine' },
    icon: Library,
    href: '/settings/document-parsing',
  },
  {
    key: 'chat',
    label: { zh: '聊天', zhTW: '聊天', en: 'Chat' },
    blurb: {
      zh: '工具、MCP 服务器、能力与附件',
      zhTW: '工具、MCP 伺服器、能力與附件',
  ...
  {
    key: 'agents',
    label: { zh: '伙伴和智能体', zhTW: '夥伴和智慧體', en: 'Partners & Agents' },
    blurb: {
      zh: '配置可在对话中调用的子智能体',
      zhTW: '配置可在對話中呼叫的子智慧體',
...
const HUB_LABEL: Lang = { zh: '设置', zhTW: '設定', en: 'Settings' }
...
const TOOLBARLESS_LEAF_ROUTES = new Set<string>(['/settings/realtime-voice'])
