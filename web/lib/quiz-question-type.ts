...
export function normalizeQuizQuestionType(value: unknown): NormalizedQuizQuestionType {
 ...
 */
export function resolveConceptAnswer(correctAnswer: unknown): 'true' | 'false' | '' {
